...
function explain(p: ImportPreview, d: Diagnostic) {
  ...
  switch (d.code) {
    ...
    case 'target_icons': return { title: 'Иконки выбираются в co-wallet', action: 'Для новых категорий выберите иконки в разделе «Общие категории» выше. Автоматического переноса иконок Monefy нет; существующие иконки сохраняются.' }
