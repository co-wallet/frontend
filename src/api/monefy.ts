...
export const monefyApi = {
  ...
  configure: async (id: string, kinds: Record<string, AccountKind>) => (await apiClient.post<ImportPreview>(`${base}/${encodeURIComponent(id)}/options`, { account_kinds: kinds })).data,
