...
const category = { id: 'layout-category', name: 'Продукты', type: 'expense', parentId: null, icon: 'preset:groceries', children: [] }
const transaction = {
...
axios.defaults.adapter = async (config) => {
  ...
  let data: unknown = []
  if (url === '/analytics/summary') data = { balance: 12500, expenses: 1234.56, income: 20000 }
    ...
    else if (url === '/categories') data = [category]
